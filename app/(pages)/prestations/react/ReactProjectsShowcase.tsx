  ...
  const projects = [
    {
      ...
      description:
        'Portfolio personnel développé entièrement avec Next.js 15, TypeScript et Tailwind CSS. Architecture moderne avec App Router, optimisations SEO et performance.',
      technologies: [
        'Next.js 15',
        'TypeScript',
        'Tailwind CSS',
    ...
    },
    {
      ...
      description:
        "Interface d'administration pour plateforme e-commerce avec gestion des commandes, statistiques en temps réel et inventaire. Développé avec React et Chart.js.",
      technologies: [
        'React 18',
        'TypeScript',
        'Chart.js',
    ...
    },
    {
      ...
      description:
        'Plateforme SaaS pour gestion de campagnes marketing avec analytics avancés, A/B testing et intégrations multiples. Architecture micro-frontends.',
    ...
    },
    {
      ...
      description:
        'Application mobile cross-platform pour la gestion de tâches collaboratives avec synchronisation temps réel et notifications push.',
      technologies: [
        'React Native',
        'Expo',
        'Firebase',
    ...
    },
    {
      ...
      description:
        'Boutique en ligne haute performance avec catalogue produits dynamique, panier avancé et checkout optimisé. Intégration Stripe et stock management.',
      technologies: [
        'Next.js',
        'Shopify API',
        'Framer Motion',
    ...
    },
    {
      ...
      description:
        'LMS (Learning Management System) avec player vidéo personnalisé, progression tracking et certification automatique. Interface élève et formateur.',
