...
const ECOMMERCE_SERVICES: EcommerceService[] = [
  {
    ...
    description: 'Création et personnalisation de boutiques e-commerce PrestaShop'
  },
  {
    name: 'Développement boutique WooCommerce',
    description: 'Création et personnalisation de boutiques e-commerce WooCommerce'
  },
  {
    name: 'Migration e-commerce',
    description: 'Migration de boutiques PrestaShop vers WooCommerce ou vice-versa'
  }
]
...
export function generateEcommerceMetadata(): PortfolioPageMetadata {
  return {
    title: 'Portfolio E-commerce La Rochelle | Réalisations PrestaShop & WooCommerce',
    description: 'Portfolio e-commerce : 7 réalisations PrestaShop et WooCommerce à La Rochelle. Boutiques B2B, migrations, optimisations. Développeur freelance Charente-Maritime.',
    keywords: 'portfolio e-commerce La Rochelle, réalisations prestashop woocommerce, projets boutique en ligne charente-maritime, développeur e-commerce la rochelle',
    openGraph: {
      title: 'Portfolio E-commerce La Rochelle | Réalisations PrestaShop & WooCommerce',
      description: 'Portfolio e-commerce : 7 réalisations PrestaShop et WooCommerce à La Rochelle. Boutiques B2B, migrations, optimisations par développeur freelance.',
...
export function generateEcommerceJsonLd(): JsonLdCollectionPage {
  return {
    ...
    description: 'Portfolio e-commerce présentant 7 réalisations de boutiques PrestaShop et WooCommerce développées à La Rochelle et en Charente-Maritime.',
    url: getCanonicalUrl(`${RouteLink.portfolio}/e-commerce`),
    mainEntity: {
      '@type': 'Person',
      ...
      knowsAbout: ['E-commerce', 'PrestaShop', 'WooCommerce', 'WordPress', 'Migration e-commerce'],
      hasOfferCatalog: {
        '@type': 'OfferCatalog',
