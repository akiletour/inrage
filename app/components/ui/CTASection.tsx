...
export default function CTASection({
  ...
  return (
    <div
      className={`bg-gray-dark/30 backdrop-blur-sm rounded-lg p-12 lg:p-16 border border-gray-dark/50 ${className}`}
    >
      ...
      <div className="flex flex-col sm:flex-row gap-8 sm:gap-12">
        ...
        >
          ...
          <svg
            className="ml-4 w-8 h-8 lg:w-10 lg:h-10 group-hover:translate-x-2 transition-transform duration-300"
            fill="none"
            stroke="currentColor"
            viewBox="0 0 24 24"
          >
