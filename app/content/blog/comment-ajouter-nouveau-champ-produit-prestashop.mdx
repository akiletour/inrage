...
date: '2019-05-19'
category: 'PrestaShop'
thumbnail: '/images/articles/comment-ajouter-nouveau-champ-produit-prestashop.jpg'
excerpt: 'Ajouter un nouveau champ produit personnalisé dans Prestashop 1.7 ou 1.6 n''est pas très compliqué en soit quand on sait où le faire.'
---

import MdxIntroduction from '../../components/ui/MdxIntroduction'

<MdxIntroduction>Ajouter un nouveau champ produit personnalisé dans Prestashop n’est pas très compliqué en soit quand on sait où le faire.</MdxIntroduction>
...
Après la méthode \_\_construct(), ajoutons donc ces méthodes d’installation.
