...
date: '2021-02-03'
category: 'WordPress'
thumbnail: '/images/articles/redirection-formulaire-contact-form-7.jpg'
excerpt: 'Nous allons découvrir comment faire une redirection Contact Form 7 vers une page de confirmation (ou une URL) après la soumission du formulaire de contact.'
---

import MdxIntroduction from '../../components/ui/MdxIntroduction'

<MdxIntroduction>Nous allons découvrir comment faire une redirection avec Contact Form 7 vers une page de confirmation (ou une URL) après la soumission d’un formulaire.</MdxIntroduction>
...
![Double message de confirmation](/images/articles/redirection-formulaire-contact-form-7-1.gif)
...
![](/images/articles/redirection-formulaire-contact-form-7-2.png)

_Exemple de configuration d’un formulaire de contact (Contact Form 7)_
