...
date: '2019-04-15'
category: 'WordPress'
thumbnail: '/images/articles/trouver-id-page-parente-arborescence-wordpress.jpg'
excerpt: 'Nous allons voir comment trouver l''ID de la page parente la plus haute dans l''arborescence sur WordPress permettant de styliser avec une classe spécifique.'
---

import MdxIntroduction from '../../components/ui/MdxIntroduction'

<MdxIntroduction>Dans le cadre d’un projet sur [WordPress](/prestations/creation-site-web/site-wordpress), mon client avait l’idée de faire un site qui se compose en deux arborescences bien distinctes :</MdxIntroduction>
