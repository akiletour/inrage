...
date: '2021-03-16'
category: 'Serveur'
thumbnail: '/images/articles/creer-serveur-mysql-replication-slave-des-donnees-master.jpg'
excerpt: 'MySQL Master-Slave Replication est une procédure permettant de répliquer en temps réel les données d''un serveur MySQL vers un autre. Nous allons voir'
---

import MdxIntroduction from '../../components/ui/MdxIntroduction'

<MdxIntroduction>MySQL Master-Slave Replication est une procédure permettant de répliquer en temps réel les données d’un serveur MySQL vers un autre. Nous allons voir ensemble comment mettre cette combinaison en place.</MdxIntroduction>
...
![montée en température serveur OVH](/images/articles/creer-serveur-mysql-replication-slave-des-donnees-master-1.jpg)

_Exemple de montée en température serveur OVH_
...
<iframe src="https://giphy.com/embed/QMHoU66sBXqqLqYvGO" title="this is fine" width="480" height="270" className="mx-auto my-8" />
...
<iframe src="https://giphy.com/embed/l2JI4zgwXw5IfyssE" title="coffee" width="480" height="270" className="mx-auto my-8" />
...
-   **Seconds\_Behind\_Master** : 1575 (si ce chiffre n’est pas à 0, nous devons attendre qu’il le soit pour nous assurer que la synchronisation est terminée)
