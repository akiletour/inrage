...
<Image src="/images/articles/contact-form-7-conditional-1.jpg" alt="Une interface intuitive" width={800} height={161} className="rounded-lg mx-auto mb-4 w-full h-auto" />

<div className="grid grid-cols-1 md:grid-cols-2 gap-4 my-6">
  <Image src="/images/articles/contact-form-7-conditional-2.jpg" alt="Configuration des règles conditionnelles" width={400} height={300} className="rounded-lg block !size-full object-cover" />
  <Image src="/images/articles/contact-form-7-conditional-3.jpg" alt="Aperçu du formulaire dynamique" width={400} height={300} className="rounded-lg size-full object-cover" />
</div>
...
<div className="grid grid-cols-2 md:grid-cols-4 gap-4 my-6">
  <div className="text-center p-4 bg-[#121212] rounded-lg">
    <svg className="w-8 h-8 mx-auto mb-3 text-orange" fill="currentColor" viewBox="0 0 448 512">
    ...
    <h4 className="text-sm font-bold text-white mb-1">Égal</h4>
  ...
  <div className="text-center p-4 bg-[#121212] rounded-lg">
    ...
    <h4 className="text-sm font-bold text-white mb-1">Différent</h4>
    <p className="text-gray text-xs">Ne correspond pas</p>
  </div>

  <div className="text-center p-4 bg-[#121212] rounded-lg">
    <svg className="w-8 h-8 mx-auto mb-3 text-orange" fill="currentColor" viewBox="0 0 512 512">
      <path d="M416 208c0 45.9-14.9 88.3-40 122.7L502.6 457.4c12.5 12.5 12.5 32.8 0 45.3s-32.8 12.5-45.3 0L330.7 376c-34.4 25.2-76.8 40-122.7 40C93.1 416 0 322.9 0 208S93.1 0 208 0S416 93.1 416 208zM208 352a144 144 0 1 0 0-288 144 144 0 1 0 0 288z"/>
    </svg>
    <h4 className="text-sm font-bold text-white mb-1">Contient</h4>
  ...
  <div className="text-center p-4 bg-[#121212] rounded-lg">
    ...
    <h4 className="text-sm font-bold text-white mb-1">Ne contient pas</h4>
    <p className="text-gray text-xs">Texte non inclus</p>
  </div>

  <div className="text-center p-4 bg-[#121212] rounded-lg">
    <svg className="w-8 h-8 mx-auto mb-3 text-orange" fill="currentColor" viewBox="0 0 384 512">
    ...
    <h4 className="text-sm font-bold text-white mb-1">Est vide</h4>
  ...
  <div className="text-center p-4 bg-[#121212] rounded-lg">
    ...
    <h4 className="text-sm font-bold text-white mb-1">N'est pas vide</h4>
    <p className="text-gray text-xs">Contient une valeur</p>
  </div>

  <div className="text-center p-4 bg-[#121212] rounded-lg">
    <svg className="w-8 h-8 mx-auto mb-3 text-orange" fill="currentColor" viewBox="0 0 320 512">
      <path d="M182.6 137.4c-12.5-12.5-32.8-12.5-45.3 0l-128 128c-9.2 9.2-11.9 22.9-6.9 34.9s16.6 19.8 29.6 19.8H288c12.9 0 24.6-7.8 29.6-19.8s2.2-25.7-6.9-34.9l-128-128z"/>
    </svg>
    <h4 className="text-sm font-bold text-white mb-1">Supérieur à</h4>
  ...
  <div className="text-center p-4 bg-[#121212] rounded-lg">
    ...
    <h4 className="text-sm font-bold text-white mb-1">Inférieur à</h4>
    <p className="text-gray text-xs">Comparaison numérique</p>
  </div>
</div>
...
<div className="grid grid-cols-1 md:grid-cols-3 gap-4 my-6">
  <div className="flex items-center gap-3 p-4 bg-[#121212] rounded-lg border border-orange">
    <div className="w-8 h-8 bg-orange text-[#121212] rounded-full flex items-center justify-center font-black text-2xl flex-shrink-0">
      1
    </div>
    <div className="flex-1">
      <h4 className="text-white font-semibold text-base mb-1">Installation</h4>
  ...
  <div className="flex items-center gap-3 p-4 bg-[#121212] rounded-lg border border-orange">
    ...
    <div className="flex-1">
      <h4 className="text-white font-semibold text-base mb-1">Prérequis</h4>
      <p className="text-gray-400 text-xs">Assurez-vous que Contact Form 7 est actif</p>
    </div>
  </div>
  ...
  <div className="flex items-center gap-3 p-4 bg-[#121212] rounded-lg border border-orange">
    ...
    <div className="flex-1">
      <h4 className="text-white font-semibold text-base mb-1">Création des groupes</h4>
      <p className="text-gray-400 text-xs">Utilisez le générateur de balises group</p>
    </div>
  </div>
  ...
  <div className="flex items-center gap-3 p-4 bg-[#121212] rounded-lg border border-orange">
    ...
    <div className="flex-1">
      <h4 className="text-white font-semibold text-base mb-1">Configuration visuelle</h4>
      <p className="text-gray-400 text-xs">Allez dans l'onglet "Simple Conditional Fields"</p>
    </div>
  </div>
  ...
  <div className="flex items-center gap-3 p-4 bg-[#121212] rounded-lg border border-orange">
    ...
    <div className="flex-1">
      <h4 className="text-white font-semibold text-base mb-1">Règles conditionnelles</h4>
      <p className="text-gray-400 text-xs">Créez vos règles avec l'interface visuelle</p>
    </div>
  </div>
  ...
  <div className="flex items-center gap-3 p-4 bg-[#121212] rounded-lg border border-orange">
    ...
    <div className="flex-1">
      <h4 className="text-white font-semibold text-base mb-1">Test et validation</h4>
