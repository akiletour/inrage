...
<Image src="/images/articles/contact-form-7-conditional-1.jpg" alt="Une interface intuitive" width={800} height={161} className="rounded-lg mx-auto mb-8 w-full h-auto" />
...
<div className="grid grid-cols-2 md:grid-cols-4 gap-8 my-12">
  ...
  <div className="text-center p-8 bg-[#121212] rounded-lg">
    <svg className="w-16 h-16 mx-auto mb-6 text-orange" fill="currentColor" viewBox="0 0 512 512">
  ...
  <div className="text-center p-8 bg-[#121212] rounded-lg">
    <svg className="w-16 h-16 mx-auto mb-6 text-orange" fill="currentColor" viewBox="0 0 384 512">
...
<div className="grid grid-cols-1 md:grid-cols-3 gap-8 my-12">
  ...
  <div className="flex items-center gap-6 p-8 bg-[#121212] rounded-lg border border-orange">
    ...
    <div className="flex-1">
      <h4 className="text-white font-semibold text-base mb-2">Création des groupes</h4>
  ...
  <div className="flex items-center gap-6 p-8 bg-[#121212] rounded-lg border border-orange">
    ...
    <div className="flex-1">
      <h4 className="text-white font-semibold text-base mb-2">Configuration visuelle</h4>
  ...
  <div className="flex items-center gap-6 p-8 bg-[#121212] rounded-lg border border-orange">
    ...
    <div className="flex-1">
      <h4 className="text-white font-semibold text-base mb-2">Règles conditionnelles</h4>
