...
date: '2020-07-26'
category: 'WordPress'
thumbnail: '/images/articles/personnaliser-design-e-mails-contact-form-7.jpg'
...
<MdxIntroduction>Nous allons voir comment personnaliser le design des e-mails Contact Form 7, pour que vos utilisateurs se sentent comme à la maison à la place du design inexistant par défaut disponible dans Contact Form 7.</MdxIntroduction>
...
![Template e-mail Topol](/images/articles/personnaliser-design-e-mails-contact-form-7-1.png)

_Exemple de création d’un e-mail transactionnel avec topol.io_
...
On va devoir utiliser le hook wpcf7\_before\_send\_mail pour nous permettre de récupérer le contenu de l’e-mail pour le modifier avec notre design.
...
### Utilisation via des shortcodes et le hook wpcf7\_before\_send\_mail
