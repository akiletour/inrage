...
<Image
  src="/images/articles/octa-wp.webp"
  alt="Octa WordPress Theme"
  width={800}
  height={400}
...
<div className="text-center italic">
  🔗 Dépôt :
  **[https://github.com/inrage/octa](https://github.com/inrage/octa)**
</div>
...
- Configuration centralisée (_configuration over code_) :
...
- Architecture _MVC‑like_ améliorant lisibilité & maintenabilité.
...
<Image
  src="/images/articles/octa-stack.webp"
  priority
  alt="Octa WordPress Theme"
  width={800}
  height={400}
  className="rounded-lg size-auto mx-auto mb-8"
/>
...
<table>
  <tbody>
    ...
    <tr>
      <td>
        <span>Juste le thème</span>
      </td>
      <td>
        <span>Projet complet prêt à cloner</span>
      </td>
    </tr>
    <tr>
      <td>
        <span>Bedrock/Acorn/Docker à intégrer soi‑même</span>
      </td>
      <td>
        <span>Déjà assemblés</span>
      </td>
    </tr>
    <tr>
      <td>
        <span>Peu d’exemples</span>
      </td>
      <td>
        <span>Composants Blade, configs CPT, CI de base</span>
      </td>
    </tr>
    <tr>
      <td>
        <span>Organisation à construire</span>
      </td>
      <td>
        <span>Architecture Laravel‑like prête</span>
      </td>
    </tr>
  </tbody>
</table>
