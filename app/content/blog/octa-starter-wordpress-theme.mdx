...
<Image src="/images/articles/octa-wp.webp" alt="Octa WordPress Theme" width={800} height={400} className="rounded-lg mx-auto mb-8 w-full h-auto" />
...
<div className="bg-gray-darker mt-8 container-full-size">
  <Diagonal
    flipX
    flipY
  ...
  <div className="container text-center py-16 lg:py-0">
    <div className="md:px-36 text-lg">
      <Quote message="Démarre un projet WordPress comme une app Laravel, avec la vélocité d’un front moderne." />
    </div>
  </div>
  <Diagonal
    className="h-16 md:h-32 lg:h-48"
...
<Image src="/images/articles/octa-stack.webp" priority alt="Octa WordPress Theme" width={800} height={400} className="rounded-lg size-auto mx-auto mb-8" />
...
<table>
  <tbody>
  <tr>
    <th><span>Sage seul</span></th>
    <th><span>Octa</span></th>
  </tr>
  <tr>
    <td><span>Juste le thème</span></td>
    <td><span>Projet complet prêt à cloner</span></td>
  </tr>
  <tr>
    <td><span>Bedrock/Acorn/Docker à intégrer soi‑même</span></td>
    <td><span>Déjà assemblés</span></td>
  </tr>
  <tr>
    <td><span>Peu d’exemples</span></td>
    <td><span>Composants Blade, configs CPT, CI de base</span></td>
  </tr>
  <tr>
    <td><span>Organisation à construire</span></td>
    <td><span>Architecture Laravel‑like prête</span></td>
  </tr>
  </tbody>
</table>
