...
<Image src="/images/articles/octa-wp.webp" alt="Octa WordPress Theme" width={800} height={400} className="rounded-lg mx-auto mb-4 w-full h-auto" />
...
<div className="bg-gray-darker mt-4 container-full-size">
  <Diagonal
    flipX
    flipY
...
<Image src="/images/articles/octa-stack.webp" priority alt="Octa WordPress Theme" width={800} height={400} className="rounded-lg size-auto mx-auto mb-4" />
