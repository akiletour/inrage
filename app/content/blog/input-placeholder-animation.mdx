...
<Image src="/images/articles/input-placeholder-anime.gif" alt="une animation typewriter intelligente qui cycle entre différents termes de recherche" width={800} height={161} className="rounded-lg mx-auto mb-4 w-full h-auto" />
...
<div className="grid grid-cols-1 md:grid-cols-3 gap-6 my-4">
  <div className="text-center p-4 bg-[#121212] rounded-lg">
    <svg className="w-12 h-12 mx-auto mb-4 text-orange" fill="currentColor" viewBox="0 0 576 512">
  ...
  <div className="text-center p-4 bg-[#121212] rounded-lg">
    <svg className="w-12 h-12 mx-auto mb-4 text-orange" fill="currentColor" viewBox="0 0 512 512">
...
<div className="grid grid-cols-1 md:grid-cols-3 gap-4 my-6">
  <div className="p-3 border border-gray rounded-lg bg-gray-darker">
    <h3 className="text-lg font-bold text-orange mb-2 flex items-center">
  ...
  <div className="p-3 border border-gray rounded-lg bg-gray-darker">
    ...
    <p className="text-sm mb-2">L'animation comprend quand l'utilisateur veut interagir :</p>
    <ul className="space-y-1 text-sm">
  ...
  <div className="p-3 border border-gray rounded-lg bg-gray-darker">
    ...
    <p className="text-sm mb-2">L'optimisation technique garantit une exécution fluide :</p>
    <ul className="space-y-1 text-sm">
