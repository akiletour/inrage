...
date: '2019-04-26'
category: 'WordPress'
thumbnail: '/images/articles/ajouter-champ-extrait-pages-wordpress.jpg'
excerpt: 'Comment ajouter un nouveau champ extrait (excerpt) dans les pages WordPress pour pouvoir récupèrer l''extrait de la page dans les résultats de recherche.'
---

import MdxIntroduction from '../../components/ui/MdxIntroduction'

<MdxIntroduction>Contrairement aux articles de WordPress, les pages ne possèdent pas de champ extrait. C’est pourtant une information qui peut être utile  dans l’utilisation de notre thème.</MdxIntroduction>
...
![Ajouter champ extrait dans une page WordPress](/images/articles/ajouter-champ-extrait-pages-wordpress-1.png)
