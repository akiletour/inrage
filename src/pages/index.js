  ...
  return (
    <Wrapper>
      ...
      <SectionTitle as={2} title="À propos">
        Développeur Freelance créatif et innovant basé au coeur de La Rochelle
        et spécialisé dans la création de site Internet.
      </SectionTitle>
      ...
      <FullSize style={{ marginTop: space(3), backgroundColor: '#000' }}>
        ...
        <Wrapper style={{ color: 'white', textAlign: 'center' }}>
          ...
          <p>
            Simple et en toute transparence, découvrez notre outil pour estimer
            le coût de votre projet. Si le budget est dans l’ordre de prix de
            vos attentes, nous pouvons vous faire une proposition commerciale et
            définir ensemble un cahier des charges complet de vos
            fonctionnalités.
          </p>
        </Wrapper>
