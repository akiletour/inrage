...
<Callout>On va voir comment créer une URL WordPress personnalisée quand on utilise le moteur du thème Sage développé par Roots pour les besoins de notre thème et de son intégration.</Callout>
