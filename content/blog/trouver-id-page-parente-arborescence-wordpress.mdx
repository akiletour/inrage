...
<Callout>Dans le cadre d'un projet sur [WordPress](/services/wordpress/), mon client avait l'idée de faire un site qui se compose en deux arborescences bien distinctes</Callout>
