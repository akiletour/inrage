...
export default function TmaOnDemand() {
  return (
    <Layout>
      <NextSeo
        title="Développement, maintenance et intervention ponctuelle site web | Freelance - inRage"
        description="Développeur freelance, je peux intervenir ponctuellement sur votre site sous forme d’heures de développement, que ce soit pour l’intégration d’un nouveau bloc ou une nouvelle fonctionnalité."
      />
