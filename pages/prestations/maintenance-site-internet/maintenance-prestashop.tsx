      ...
      <div className="container">
        <TextImage position="right" image={LogoGrey}>
          <div className="text-left">
            <h2>
              <span className="text-orange uppercase text-4xl font-medium">Maintenance et Sécurité</span>
              <span className="block text-white font-light text-3xl">Prestashop</span>
            </h2>

            <p className="mt-3 text-xl text-gray-light">Depuis des années j’administre et assiste les créateurs e-commerce dans ce vaste monde qui est Internet.</p>
            <p className="mt-3 text-gray-light">Chaque jour, des boutiques sont victimes de failles de sécurité ou d’attaques. J’ai appris et développé au fil des années des outils me permettant de surveiller, protéger et réparer ces failles et bloquer ces attaques.</p>
            <p className="mt-3 text-gray-light">Toutes les heures, mes outils inspectent chacune de vos pages pour en vérifier l’intégrité de son contenu. Tester les formulaires d’inscription, de connexion et panier.</p>
          </div>
        </TextImage>
      </div>
  ...
  return {
    props: {
      entries: [{
        ...
        excerpt: 'Scan de sécurité toutes les heures, rapport disponible dans une interface dédiée. Surveillance des mises à jour de vos extensions, Prestashop et thème.',
        values: [true, true],
      }, {
        id: 3,
        ...
        excerpt: 'Dans le forfait « Sérénité », l’astreinte est de 9h à 19h, du lundi au vendredi inclus.',
        values: [false, true],
      }, {
        id: 11,
        name: 'GTI',
