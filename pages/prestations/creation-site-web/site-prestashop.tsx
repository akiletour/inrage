    ...
    <>
      ...
      <div className="container flex items-center">
        ...
        <div className="md:w-3/5 text-lg md:pl-5 leading-6 pt-2">
          ...
          <p className="mt-2">
            Prestashop est un CMS gratuit et opensource. Il
            est 100% administrable et son interface d’administration est claire
            et sobre.
          </p>
          <p className="mt-2">
            A l’instar de Wordpress, Prestashop bénéficie
            d’une large communauté, très investie. Les plugins et thèmes
            disponibles pour ce CMS sont donc extrêmement nombreux. En somme,
            Prestashop est un CMS simple et fiable, c’est l’outil idéal pour la
            création de boutique e-commerce.
          </p>
          <p className="mt-2">
            Pour ma part, je développe sur Prestashop depuis
            2013 lors de la sortie de la version 1.4 du CMS.
          </p>
        </div>
      </div>
      ...
      <div className="bg-gray-darker mt-4">
        ...
        <div className="container text-center py-8 lg:py-0">
          <div className="md:px-18 text-lg">
            <h2 className="text-3xl text-white font-bold mb-2">Pourquoi choisir Prestashop ?</h2>

            <p>
              Prestashop est le CMS de référence pour la création de boutique
              en ligne et plus largement pour le e-commerce. Il permet à mes
      ...
      <div className="container">
        ...
        >
          <p>
            ...
            site e-commerce puis je développe le thème prestashop dans le respect
            de vos choix graphiques et fonctionnels. Cette étape est cruciale car
            elle définit ce que les visiteurs pourront visualiser sur votre
            boutique. Tous les thèmes que je développe sont consultables sur tous
            les terminaux (responsive design).

          </p>

          <p className="mt-2">
            Je respecte scrupuleusement les bonnes pratiques
            dictées par Prestashop et sa communauté. C’est pourquoi je préfère
            développer intégralement un thème plutôt que d’en utiliser un
            existant. Ainsi, les sites que je développe sont plus rapides à
            l’affichage, plus fiables et plus pérennes dans le temps.
        ...
        >
          <p>
            Comme pour le CMS Wordpress, la communauté Prestashop est
            importante et particulièrement investie. De fait, le catalogue de ses
            modules existants est très complet. Pourtant, selon vos besoins ou
            les enjeux de votre activité, il peut être nécessaire de développer
          ...
          <p className="mt-2">
            ...
            pratiques véhiculées par Prestashop et utilisent le système de “Hook”
            pour réaliser des actions sans modifier le coeur du CMS. Ces modules
            sont réplicables sur l’ensemble des sites développés sous
            Prestashop.
          </p>
        </TextImage>
      </div>
        ...
        <div className="container text-center py-8 lg:py-0">
          <div className="">
            <h2 className="text-center text-white text-3xl">
              ...
              <span className="block text-xl">Un outil pour vous faciliter la vie</span>
            </h2>
            <p className="text-xl text-gray-light mt-3">
              La dernière version de
              Prestashop (1.7.5) est très largement plébiscitée par la communauté
              pour ses performances et sa fiabilité. Notamment car elle est
              développée sur la base du framework Symfony.
            </p>
            <p className="mt-2">
              En 2019, de nombreuses sociétés ont fait part à
              leurs développeurs, de leur souhait de migrer leur boutique sur la
              nouvelle version de Prestashop. Afin de rendre cette migration plus
              simple et plus rapide, j’ai créé un outil dédié me permettant de
              réaliser cette migration et ainsi d’éviter la création d’un nouveau
              site.
            </p>
          </div>
        </div>
      ...
      <div className="container">
        <h2 className="text-white text-3xl font-bold mb-4">L&apos;intégration de votre catalogue produit</h2>
        <p>
        ...
        <p className="mt-2">
          ...
          votre catalogue, j&apos;ai développé des outils permettant d&apos;injecter
          facilement vos références dans Prestashop via une API, un tableau CSV
          ou XLS).
        </p>
        <p className="mt-2">
      ...
      <div className="bg-gray-darker">
        <div className="container -mb-8 relative z-10">
          <SectionTitle
            ...
            content="Retrouvez ci-dessous quelques projets auxquels j'ai eu l'occassion de collaborer dessus en tant que développeur freelance sur Prestashop."
          />
...
export const getStaticProps: GetStaticProps = async (): Promise<StaticProps> => {
  const relatedProjects = await LastProjectBySupport('prestashop');
  return {
    props: {
      pageTitle: 'Création de site Prestashop',
      breadcrumb: [{
        link: '/prestations',
