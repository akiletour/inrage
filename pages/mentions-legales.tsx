  ...
  return (
    <Layout>
      <div className="container">
        ...
        <p>
          <div>Pascal GAULT</div>
          <div>Société : inRage SARL</div>
          <div>Adresse : 10 rue Jean Perrin 17000 LA ROCHELLE</div>
          <div>Courriel : contact(at)inrage.fr</div>
          <div>Tél : +33 (0)6 51 89 89 17</div>
        </p>
